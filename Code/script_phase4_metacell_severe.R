...
png("results_severe/barplot2.png",h=1000,w=1000);barplot(lfp["NFKB1",],col=marks_colors,las=2,main="NFKB1",cex.main=3,cex.axis=1,ylab="log2FC",xlab="metacells");dev.off()
