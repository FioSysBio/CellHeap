...
#mild
mcell_import_scmat_tsv(mat_nm = "all", fn = "/scratch/inova-covd19/vanessa.silva/paper/features_not_infected_mild.tsv", dset_nm = "/scratch/inova-covd19/vanessa.silva/paper/metadata_mild.csv", force = F)
mat = scdb_mat("all")
print(dim(mat@mat))
head(mat@mat)
...
mc_colorize_sup_hierarchy(mc_id="new_mc_f", supmc=mc_sup, supmc_key="/scratch/inova-covd19/vanessa.silva/paper/supmc_new.csv", gene_key=NULL)
